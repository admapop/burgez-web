                ...
                <Breakpoint tablet down>
                    ...
                    <form className="" onSubmit={this.handleSubmit}>
                        <div className="fl w-90" style={{ display: this.state.isToggle ? 'none' : 'block' }}>
                            <div className="">
                                <label htmlFor="name" className="fl w-100 f2 fw4 b db mb2">NOME E COGNOME</label>
                                <input className="w-100 bn pv2" type="text" name="name" id="name" value={this.state.value} onChange={this.handleChange} />
                            </div>
                            <div className="">
                                <label htmlFor="tel" className="fl w-100 f2 fw4 b db mb2">TELEFONO O CELLULARE</label>
                                <input className="w-100 bn pv2" type="tel" name="tel" id="tel" />
                            </div>
                            <div className="">
                                <label htmlFor="email" className="fl w-100 f2 fw4 b db mb2">EMAIL</label>
                                <input className="w-100 bn pv2" type="email" name="email" id="email" value={this.state.value} onChange={this.handleChange} />
                            </div>
                            <div className="">
                                <label htmlFor="type" className="fl w-100 f2 fw4 b db mb2">TIPO OFFERENTE</label>
                        ...
                        <div className="fl w-90" style={{ display: this.state.isToggle ? 'none' : 'block' }}>
                            <div className="">
                                <label htmlFor="address" className="fl w-100 f2 fw4 b db mb2 ">INDIRIZZO</label>
                                <input className="w-100 bn pv2 " type="text" name="address" id="address" value={this.state.value} onChange={this.handleChange} />
                            </div>
                            <div className="">
                                <label htmlFor="civico" className="fl w-100 f2 fw4 b db mb2 ">CIVICO</label>
                                <input className="w-100 bn pv2 " type="text" name="civico" id="civico" />
                            </div>
                            <div className="">
                                <label htmlFor="cap" className="fl w-100 f2 fw4 b db mb2 ">CAP</label>
                                <input className="w-100 bn pv2 " type="text" name="cap" id="cap" />
                            </div>
                            <div className="">
                                <label htmlFor="city" className="fl w-100 f2 fw4 b db mb2 ">CITTà</label>
                        ...
                        <div className="fl w-90" style={{ display: this.state.isToggle ? 'block' : 'none' }}>
                            <div className="page2">
                                <label htmlFor="r_proposta" className="fl w-100 f2 fw4 b db mb2 ">IL LOCALE VIENE PROPOSTO IN</label>
                                <div className="fl w-20">
                                    <input className="w-25 bn pv2" type="radio" name="r_proposta" id="locazione" value={''} />
                                    <label htmlFor="r_proposta" className="w-25 radio-b">Locazione</label>
                                </div>
                            ...
                            <div className="page2">
                                <label htmlFor="cannafumaria" className="fl w-100 f2 fw4 b db mb2 ">CANNA FUMARIA</label>
                                <div className="fl w-20">
                                    <input className="w-25 bn pv2" type="radio" name="cannafumaria" id="sì" value={''} />
                                    <label htmlFor="cannafumaria" className="w-25 radio-b">Sì</label>
                                </div>
                            ...
                            <div className="page2">
                                <label htmlFor="cannainstall" className="fl w-100 f2 fw4 b db mb2 ">SE NO, E' POSSIBILE INSTALLARLA?</label>
                                <div className="fl w-20">
                                    <input className="w-25 bn pv2" type="radio" name="cannainstall" id="sì" value={''} />
                                    <label htmlFor="cannainstall" className="w-25 radio-b">Sì</label>
                                </div>
                            ...
                            <div className="">
                                <label htmlFor="file" className="fl w-100 f2 fw4 b db mb2 ">DESIDERA INVIARE PLANIMETRIE O PDF?</label>
                        ...
                        <div className="fl w-50" style={{ display: this.state.isToggle ? 'block' : 'none' }}>
                            <div className="">
                                <label htmlFor="tot_affitto" className="fl w-100 f2 fw4 b db mb2 ">AFFITTO MENSILE</label>
                                <input className="w-100 bn pv2 " type="text" name="tot_affitto" id="tot_affitto" />
                            </div>
                            <div className="">
                                <label htmlFor="surface" className="fl w-100 f2 fw4 b db mb2 ">SUPERFICIE DISPONIBILE AL PIANO TERRA (MQ)</label>
                                <input className="w-100 bn pv2 " type="text" name="surface" id="surface" />
                            </div>
                            <div className="">
                                <label htmlFor="vetrine" className="fl w-100 f2 fw4 b db mb2 ">NUMERO VETRINE</label>
                                <input className="w-100 bn pv2 " type="text" name="vetrine" id="vetrine" />
                            </div>
                            <div className="">
                                <label htmlFor="message" className="fl w-100 f2 fw4 b db mb2 ">MESSAGGIO</label>
